...
(async () => {
    ...
    for (let currentPage = 1; currentPage <= totalPages; currentPage++) {
        ...
        for (const anchor of anchorsIn) {
            ...
            const torrentInfo = await getMovieTorrentInfo(page);
            ...
            await insertMovies(
                ...
                torrentInfo[0].director,
                torrentInfo[0].reparto,
            ...
            await insertEpisodesMovies(torrentInfo[0].aText, torrentInfo[0].releaseDate, last_id);
